# -*- coding: utf-8 -*-
"""Naive_bayes_classifieripynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1atXSTVGiqpqNy3cjTaD3m5enovR2SnjP
...
corpus = read_corpus('/content/drive/My Drive/all_sentiment_shuffled.txt') #Here '/content/drive/My Drive/Location where your file is saved' 
print("Example:\n", " Text: ", corpus[0][0], "\n  Label: ", corpus[0][1])
...
"""#Problem 1 
Make the naive bayes classifier using the sklearn.Do the following things.

1.   Make the data in the form which is required by the sklearn library.For that do the following things

*   **dat** is a mtrix where each elements of first column is a set of words and each element of the second column is "neg" and "pos".Write function to extract "neg" and "pos" which will also be a true label

*   Write a function to convert each of elements of first column from set of words to whole sentence.So output of this funtion will be array whose elements will be a sentence which is made by joining set of words.

* from sklearn.feature_extraction.text import CountVectorizer

*  We will use CountVectorizer to "convert text into a matrix of token counts".The 4 steps of CountVectorize is:-import,instantiate,fit,transform

*  Now feed output of transform and label set (using first function to test_train split
       

         

2.  Apply the multinomial naive bayes and the
